    ...
    <>
      <div className="bg-white rounded-xl p-5 border border-slate-200 flex flex-col justify-between h-full min-h-[380px] shadow-2xs">
        ...
        <div
          ...
          className="my-3 p-3 bg-slate-50 hover:bg-slate-100/80 border border-slate-200 rounded-lg cursor-pointer transition-colors"
        >
          <div className="flex items-start justify-between gap-2">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-mono uppercase text-amber-800 bg-amber-100/70 px-1.5 py-0.5 rounded border border-amber-300/80 font-bold">
                  Priority 1
                </span>
          ...
          <div className="space-y-1.5">
            {displayOthers.map((item) => (
              <div
                ...
                className="flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 cursor-pointer border border-slate-100 hover:border-slate-200 transition-colors group"
              >
